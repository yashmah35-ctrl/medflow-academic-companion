...
import { Upload, Plus, BarChart3, Archive } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Analyse les sujets des années passées pour cibler tes révisions.
          </p>
        </div>
        <Button>
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Plusieurs pages supportées. L'IA analysera les sujets les plus fréquents.
        </p>
      </motion.div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Session {a.session} • {a.pages} pages
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <Badge variant={a.analyzed ? "default" : "secondary"} className="text-xs">
                {a.analyzed ? "Analysé" : "En cours"}
              </Badge>
              <Button variant="outline" size="sm" disabled={!a.analyzed}>
                S'entraîner
              </Button>
            </div>
          </motion.div>
