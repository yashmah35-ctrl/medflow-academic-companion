...
const SRS_TABLE: Record<number, Record<SRSRating, Transition>> = {
  0: {
    ...
    easy:  { newLevel: 3, intervalDays: 1 },
  },
  1: {
    again: { newLevel: 0, intervalMinutes: 1 },
    hard:  { newLevel: 1, intervalMinutes: 5 },
    good:  { newLevel: 2, intervalMinutes: 10 },
    easy:  { newLevel: 3, intervalDays: 1 },
  },
  2: {
    again: { newLevel: 1, intervalMinutes: 3 },
    hard:  { newLevel: 1, intervalMinutes: 5 },
    good:  { newLevel: 3, intervalDays: 1 },
    easy:  { newLevel: 4, intervalDays: 3 },
  },
  3: {
    again: { newLevel: 2, intervalMinutes: 10 },
    hard:  { newLevel: 2, intervalMinutes: 10 },
    good:  { newLevel: 4, intervalDays: 3 },
    easy:  { newLevel: 5, intervalDays: 7 },
  },
  4: {
    again: { newLevel: 3, intervalDays: 1 },
    hard:  { newLevel: 3, intervalDays: 1 },
    good:  { newLevel: 5, intervalDays: 7 },
    easy:  { newLevel: 6, intervalDays: 21 },
  },
  5: {
    again: { newLevel: 4, intervalDays: 3 },
    hard:  { newLevel: 4, intervalDays: 3 },
    good:  { newLevel: 6, intervalDays: 21 },
    easy:  { newLevel: 6, intervalDays: 30 },
  },
  6: {
    again: { newLevel: 5, intervalDays: 7 },
    hard:  { newLevel: 5, intervalDays: 7 },
    good:  { newLevel: 6, intervalDays: 30 },
    easy:  { newLevel: 6, intervalDays: 60 },
  },
};
